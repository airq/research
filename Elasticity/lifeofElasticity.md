...
也许体验过比如为某件事全力以赴的状态。也有因为某件事低谷的状态。
...
在一些情形下，做出某一个选择或某一行动往往是内秉属性所决定的必然结果。

## 在错开的角度下，存在着人生的另一种极限。

弹性力学“最大切应力”，在与正应力方向成45°的平面上，存在着最大的切向应力。
...
此外，运用圣维南原理简化问题、而求解还能足够精确，这表明，解决问题或者做出判断，要果断抛弃次要因素。
...
## 即使再大的物体，内部再小的孔洞也很容易会成为损伤之处。


弹性力学“含孔平板的解”：无论孔的半径多么小、板的尺寸多么大（无限大），受力时的应力分布峰值总是3倍于施加的外力（应力集中系数=3），应力峰值总是在孔洞边缘。半径只影响下降的趋势线。
...
疲劳：水滴石穿、手折钢丝都是基于疲劳的原理。即使外力再小，远小于强度，往复的作用也很容易产生不可逆的损伤。
